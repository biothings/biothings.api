...
class HubServer(object):
    ...
    def configure_commands(self):
        ...
        if self.managers.get("snapshot_manager"):
            ...
            self.commands["sync_snapshots"] = self.managers["snapshot_manager"].sync_snapshots
    ...
    def configure_api_endpoints(self):
        ...
        if "sync_snapshots" in cmdnames:
            self.api_endpoints["sync_snapshots"] = EndpointDefinition(name="sync_snapshots", method="post")
        if "sync" in cmdnames:
