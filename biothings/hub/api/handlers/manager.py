...
class ManagerHandler(BaseHandler):
    ...
    def diff_info(self,differ_manager):
        return {"tdb":True}
    ...
    def get(self,name=None):
        ...
        for managername,manager in self.managers.items():
            ...
            if info_func:
                info_func = getattr(self,info_func)
