...
def test_inspection_not_order_specific():
...
def test_inspection_same_key_different_types():
...
def test_inspection_same_key_different_types_with_list():
...
def test_inspection_same_key_different_types_with_list_and_dict():
...
def test_inspection_merge_stats():
...
def test_inspection_mapping_simple():
...
def test_inspection_mapping_with_list_of_list_of_integer():
...
def test_inspection_mapping_scalar_or_list():
...
def test_inspection_merge_mix_scalar_list_with_stats():
...
def test_inspection_stats_with_same_docs():
    d1 = {
        "go": {
            "BP": {
...
def test_inspection_merge_deeply_nested():
...
def test_inspection_merge_with_splitstr():
...
def test_inspection_merge_record():
...
def test_15_mapping_with_int_float():
...
def test_16_mapping_with_nan_inf():
